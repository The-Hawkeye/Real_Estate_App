    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className="flex flex-col flex-1">
                ...
                <button disabled={loading || imageUploadError} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-60">{loading?"Creating....":"Create Listing"}</button>
